...
const PRODUCTS = [
  { id:"w1", cat:"wasser", title:"Wasser Classic (1,5 L)", price:1.5, icon:"bubbles" },
  { id:"w2", cat:"wasser", title:"Wasser Medium (1,5 L)", price:1.5, icon:"droplets" },
  { id:"w3", cat:"wasser", title:"Stillwasser (1,5 L)", price:1.5, icon:"waves" },
  { id:"s1", cat:"soft", title:"Cola (1,5L)", price:2.9, icon:"cup-soda" },
  { id:"s2", cat:"soft", title:"Fanta (1,5L)", price:2.9, icon:"cup-soda" },
  { id:"s3", cat:"soft", title:"Sprite (1,5L)", price:2.9, icon:"cup-soda" },
  { id:"s4", cat:"soft", title:"Mezzo Mix (1,5L)", price:2.9, icon:"cup-soda" },
  { id:"s5", cat:"soft", title:"Eistee Pfirsich (1,5L)", price:2.9, icon:"cup-soda" },
  { id:"s6", cat:"soft", title:"Eistee Zitrone (1,5L)", price:2.9, icon:"cup-soda" },
  { id:"j1", cat:"saft", title:"Orangensaft (1,0L)", price:2.9, icon:"citrus" },
  { id:"j2", cat:"saft", title:"Multivitamin (1,0L)", price:2.9, icon:"apple" },
  { id:"j3", cat:"saft", title:"Apfelsaft naturtrüb (1,0L)", price:2.9, icon:"apple" },
  { id:"j4", cat:"saft", title:"Traubensaft (1,0L)", price:2.9, icon:"grape" },
  { id:"e1", cat:"energy", title:"Red Bull (0,25L)", price:3.9, icon:"zap" },
  { id:"e2", cat:"energy", title:"Monster Energy (0,5L)", price:3.9, icon:"battery-charging" },
  { id:"e3", cat:"energy", title:"Rockstar Energy (0,5L)", price:3.9, icon:"zap" },
  { id:"e4", cat:"energy", title:"Effect Energy (0,25L)", price:3.9, icon:"bolt" },
  { id:"sal1", cat:"salziges", title:"Chips Paprika (200g)", price:2.5, icon:"package" },
  { id:"sal2", cat:"salziges", title:"Chips gesalzen (200g)", price:2.5, icon:"package" },
  { id:"sal3", cat:"salziges", title:"Erdnüsse geröstet (200g)", price:2.5, icon:"nut" },
  { id:"sal4", cat:"salziges", title:"Salzstangen (150g)", price:1.5, icon:"bread" },
  { id:"sue1", cat:"suess", title:"Snickers", price:2.9, icon:"grid-3x3" },
